...
const AboutSection = () => {
  ...
  // Ambil URL gambar dari aboutData.image
  const imageUrl = aboutData.image && aboutData.image.length > 0 ? aboutData.image[0].url : '';
  ...
  return (
    ...
    <p id="paragraph" className="text-green-900 text-lg mb-6 pr-14 pb-2" data-aos="fade-up">
    ...
    {!isDesktop && aboutData.description.length > 100 && (
      ...
      className="bg-green-700 text-white text-sm px-8 py-4 rounded-md shadow-[0_ 8px_15px_rgba(0,0,0,0.6)] lg:hidden" data-aos="fade-up">
